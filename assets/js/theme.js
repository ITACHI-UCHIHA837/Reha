...
document.addEventListener("DOMContentLoaded", function () {
    ...
    .then(data => {
        ...
        data.forEach(p => {
            ...
            <a href="#" class="icon-btn wishlist-toggle">
            <i class="fa fa-heart"></i>
            </a>
            
            <a href="${p.img}" class="img-popup icon-btn">
            <i class="fa fa-eye"></i>
            </a>
            </div>
            </div>
            ...
            <div class="col-xl-4 product-card" data-brand="${p.brand}" data-price="${p.price}" data-id="${p.id}">
            ...
            <div class="hover-content">
            <a href="#" class="icon-btn wishlist-toggle"><i class="fa fa-heart"></i></a>
            <a href="${p.img}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>                                    
            </div>
            </div>
            <div class="product-info-wrap">
            <div class="product-info">
...
<div class="product-price">
<span class="price prev-price">$80.00</span>
<span class="price new-price">$${p.price}</span>
</div>
</div>
</div>
...
<div class="col-xl-4 product-card" data-id="${p.id}" data-brand="${p.brand}" data-price="${p.price}">
<div class="product-item style-one mb-40">
<div class="product-thumbnail">
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    wishlist.forEach(function(p){
        ...
        container.innerHTML += `
<div class="col-xl-3 product-card" data-id="${p.id}">
<div class="product-item style-one mb-40"> 
<div class="product-thumbnail">
<img src="${p.img}">
<div class="discount">${p.dis} </div>
<div class="hover-content">
<a href="#" class="icon-btn wishlist-toggle wishlist-active">
<i class="fa fa-heart"></i>
...
<div class="product-price"><span class="price new-price">${p.price}</span>
